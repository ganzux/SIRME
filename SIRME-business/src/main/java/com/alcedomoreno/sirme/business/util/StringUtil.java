...
public class StringUtil {
	...
	/**
	 * removeAccent --> Funci�n que elimina los acentos y los caracteres especiales de una cadena de texto.
	 *  @param input
	...
	public static String removeAccent(String input) {
	    ...
	    // Nos quedamos �nicamente con los caracteres ASCII eliminando las tildes del String
