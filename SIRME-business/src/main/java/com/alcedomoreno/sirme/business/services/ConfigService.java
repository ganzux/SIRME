...
public class ConfigService  {
	...
	private void testSpringConstants() throws Exception{
		...
		MyLogger.info( log , CLASS_NAME, "testSpringConstants", "INIT", "Comprobando que las Variables de SPRING no est�n repetidas" );

		List<Class> springConfigClasses = new ArrayList<Class>();
		springConfigClasses.add( DAOConstants.class );
		springConfigClasses.add( ServiceConstants.class );
		...
		try{
				...
				if ( fileds!=null )
					for ( Field field:fileds ){
						...
						if ( names.get(variableValue)==null )
							...
							String logStr = "Se detiene la carga de la aplicaci�n. Ya existe una configuraci�n para esa variable. '";
			...
			MyLogger.error( log , CLASS_NAME, "testSpringConstants", "Se detiene la carga de la Aplicaci�n", e.getMessage() );
	...
	private boolean photoDirExistx() throws Exception{
		...
		MyLogger.info( log , CLASS_NAME, "photoDirExistx", "Comprobando si existe directorio de im�genes", photoDirectory );
		try{
			...
			MyLogger.error( log , CLASS_NAME, "photoDirExistx", "Se detiene la carga de la Aplicaci�n", e.getMessage() );
			throw e;
		}
