...
import com.alcedomoreno.sirme.business.transform.ReportTransform;
import com.alcedomoreno.sirme.business.transform.Transformator;

public class Report implements BusinessObject,Cloneable{
	...
	public Collection<ViewTotalizer> getTotalizers(){
		...
		// Recorremos todas las respuestas, viendo si la pregunta est� en el mapa de totalizadores y a�adi�ndola
		if ( replyGroups != null )
