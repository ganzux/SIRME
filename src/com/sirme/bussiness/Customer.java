...
import com.sirme.transform.CustomerTransform;
import com.sirme.transform.ITransformator;

public class Customer implements IBusinessObject,Cloneable{

	private int idCustomer;
	private String cifCustomer;
	private String nameCustomer;	// Razón Social
	private String codeCustomer;	// Nº Cliente
	...
	// Los siguientes datos son de la dirección donde se realiza el servicio
